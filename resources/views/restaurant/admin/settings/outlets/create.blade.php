...
<div class="row page-titles">
    <div class="col"><h4 class="mb-0">Add Outlet</h4></div>
</div>

<div class="card">
    <div class="card-body">
        <form method="POST" action="{{ route('admin.settings.outlets.store') }}">
            @csrf
            <div class="row">
            ...
            <div class="mb-3 form-check">
                <input type="checkbox" name="is_primary" value="1" class="form-check-input" id="is_primary" {{ old('is_primary') ? 'checked' : '' }}>
